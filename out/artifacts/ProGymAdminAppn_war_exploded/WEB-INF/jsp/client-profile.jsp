               ...
               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                  <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                     <ul id="myTabedu1" class="tab-review-design">
                        ...
                        <li><a href="#workout_schedule">Workout Schedule</a></li>
                        <li><a href="#diet_plan">Diet Plan</a></li>
                     </ul>
                                                                  ...
                                                                  <c:forEach var = "subType" items = "${workout.workoutSubTypeList}" varStatus="status1">
                                                                     <tr>
                                                                        <td style="text-align:center;color: blue;width:50%;padding-right: 10px">
                                                                           &nbsp;&nbsp;
                                                                           <c:out value="${subType.subType.name}"/>
                                                                           &nbsp;&nbsp;
                                                                        </td>
                        ...
                        <div class="product-tab-list tab-pane fade" id="diet_plan">
                           ...
                           <div class="row">
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 ...
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 &nbsp;&nbsp;&nbsp;&nbsp;
                                 <button style="text-align:center;background-color:#000000" type="button" class="btn btn-info btn-lg" id="addDietPlanBtn">Add New Diet Plan</button>
                                 <button style="text-align:center;background-color:#000000" type="button" class="btn btn-info btn-lg" id="addTemplateDietPlanBtn">Add Template Diet Plan</button>

                                 <div class="review-content-section">
                                    <a href="<c:url value='viewActiveDietPlanByClientId?clientId=${clientObject.id}&gender=${clientObject.gender}'/>">
                                       <input class="btn btn-primary" type="button" value="&nbsp;&nbsp;View Active Template&nbsp;&nbsp;" />
                                    </a>
                                    <c:forEach items="${oldDietPlanTemplatesList}" var="obj" varStatus="status">
                                       <a href="<c:url value='viewOldDietPlanTemplate?templateId=${obj.id}&clientId=${clientObject.id}&gender=${clientObject.gender}'/>">
                                          <input class="btn btn-secondary" type="button" value="&nbsp;&nbsp;Template - ${obj.id}&nbsp;&nbsp;" />
                                       </a>
                                    </c:forEach>
                                 </br></br>
                                    ...
                                    <table style="border-spacing: 20px">
                                       ...
                                       <c:if test="${selectedDietObjectTemplate != null}">
                                          ...
                                          <tr>
                                             ...
                                             <td></td>
                                             <td>
                                                <c:if test="${clientObject.activeDietPlan.id != selectedDietObjectTemplate.id}">
