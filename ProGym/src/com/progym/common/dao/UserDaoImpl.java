...
public class UserDaoImpl implements UserDao {
    ...
    public PackageDetails getPackageDetailsById(int id) {
        // build whole client object
        PackageDetails obj = null;
        Session session = HibernateUtils.getSessionFactory().openSession();
        obj = (PackageDetails) session.createCriteria(PackageDetails.class).add(Restrictions.eq("id", id)).uniqueResult();
        session.close();
        return obj;
    }
    ...
    public void createTransaction(PaymentTransaction paymentTransaction, Boolean isAuthorized, User user) {
        ...
        PackageDetails pd = getPackageDetailsById(paymentTransaction.getPackageDetailsId());
