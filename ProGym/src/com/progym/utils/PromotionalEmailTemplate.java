...
import com.progym.utils.BdayEmailTemplate.HTMLDataSource;
import com.sun.mail.smtp.SMTPTransport;

public class PromotionalEmailTemplate {
	...
	public static void sendEmail(String email, String name , String subject , String imageUrl){
		   Properties prop = System.getProperties();
	        ...
	        try {
	            ...
	            String text = "<html><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />"
						...
						+ "<thead>      "
						+ "<tr>        "
						+ "<th style=\"text-align:left;\"><img style=\"max-width: 100px;\" src=\"https://tavrostechinfo.com/PROGYM/img/pro-gym_email_logo.jpg\" alt=\"bachana tours\"></th>"
						...
						+ "</tr>"
						+ "<tr>"
						+ "<td stype=\"text-align: center; vertical-align: middle;\"><img style=\"max-width: 300px;border-radius:10px\" src=\""+imageUrl+"\" alt=\"bachana tours\"></td>"
						+ "</tr>"
						+ "</tbody>"
						+"    <tfooter>"+
		            	"      <tr>"+
