	   ...
	   Properties prop = System.getProperties();
        ...
        try {
            ...
            String text = "<html><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />"
					...
					+ "<thead>      "
					+ "<tr>        "
					+ "<th style=\"text-align:left;\"><img style=\"max-width: 100px;\" src=\"https://i.ibb.co/RzLBKYq/pro-gym.jpg\" alt=\"bachana tours\"></th>"
					...
					+ "</tr>"
					+ "<tr>"
					+ "<td stype=\"text-align: center; vertical-align: middle;\"><img style=\"max-width: 300px;border-radius:10px\" src=\"https://www.linkpicture.com/q/dbb.jpg\" alt=\"bachana tours\"></td>"
					+ "</tr>"
					+ "<tr>"
					+ "<td stype=\"text-align: center; vertical-align: middle;\"><img style=\"max-width: 300px;border-radius:10px\" src=\"https://www.linkpicture.com/q/rsz_bday_wish.jpg\" alt=\"bachana tours\"></td>"
					+ "</tr>"
					+ "</tbody>"
					+"    <tfooter>"+
	            	"      <tr>"+
